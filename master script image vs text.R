#Replication Script for the "Online Gender Bias is Stronger in Images than Text", April 2023
...
#Load/Organize Data#
####################
data_raw<-read.csv("C:/Users/dougl/Desktop/Nature_Data/data_raw.csv")
...
data_binary_mode_agg<-data_binary %>% 
  group_by(Data.Source, Social.Category, searchDEMO, face_id, image_id, cps_majorgroup, cps_group, cps_occupation, census.women, 
           ...
           GoogleNews.300D.Gender.v4.Norm, GPT3.gender, GPT3.gender.norm) %>% 
...
data_binary_mode_agg_macro<-data_binary_mode_agg %>% 
  group_by(Data.Source, Social.Category, searchDEMO, cps_majorgroup, cps_group, cps_occupation, census.women, 
           ...
           Wiki.300D.Gender, Wiki.300D.Gender.Norm, Twitter.200D.Gender, Bert, Bert.Norm, ConceptNet, ConceptNet.Norm, FastText, FastText.Norm, Glove.Twitter, Glove.Twitter.Norm, 
           Glove.Wiki, Glove.Wiki.Norm, GoogleNews.300D.Gender.v2, GoogleNews.300D.Gender.v3, GoogleNews.300D.Gender.v4, GoogleNews.300D.Gender.v2.Norm, GoogleNews.300D.Gender.v3.Norm, 
           GoogleNews.300D.Gender.v4.Norm, GPT3.gender, GPT3.gender.norm, Img.Gender.Mode) %>% 
...
###Main Figures###
##################
savepath_main<-"C:/Users/dougl/Desktop/comp-syn/algorithmic_bias/Results/Nature_RnR_Figures/p2/main/"  #Set the path for where you want the figures to be saved. 
...
#################################
exp_dt<-read.csv('C:/Users/dougl/Desktop/Nature_Data/data_experiment.csv')
...
pairwise.t.test(fig3B$str_stereo, fig3B$condition, p.adjust.method = "none", paired=T)
...
pairwise.t.test(fig3C$dscore, fig3C$condition, p.adjust.method = "none")
...
cor.test(subset(fig3AEF, condition!="Image")$stim.str, 
         subset(fig3AEF, condition!="Image")$str_stereo, method="spearman")
...
############################
savepath_supp<-"C:/Users/dougl/Desktop/comp-syn/algorithmic_bias/Results/Nature_RnR_Figures/p2/supplementary/" #where you want the supplementary figures to be saved
...
###############################
img_sources<-read.csv("C:/Users/dougl/Desktop/Nature_Data/img_source_stats.csv")
...
GEO<-read.csv("C:/Users/dougl/Desktop/Nature_Data/GEO_replication.csv")
...
embedding_comp_long$model<-
  factor(embedding_comp_long$model, 
         levels = c("GPT3", "Bert", "Wiki Glove", "Twitter Glove", "FastText", 
                    "ConceptNet", "Google Images", "Google w2vec"))

embedding_comp_long_main<-subset(embedding_comp_long, model != "GPT3")
embedding_comp_long_GPT3<-subset(embedding_comp_long, model == "GPT3")
embedding_comp_long_GPT3$Gender.bias<-embedding_comp_long_GPT3$Gender.bias*-1

embedding_comp_long<-rbind(embedding_comp_long_main, embedding_comp_long_GPT3)

embedding_comp_long$model<-factor(embedding_comp_long$model, 
                                  levels=c("Google Images","GPT3", "Twitter Glove", "Wiki Glove", "Bert", "ConceptNet", "FastText", "Google w2vec"))
levels(embedding_comp_long$model)
ggplot(embedding_comp_long, aes(x = Gender.bias, color=model, fill=model, alpha=model)) +
  geom_density(size=2.5) + theme_bw() + 
  scale_fill_manual(values=c("purple", "grey30","deeppink2","turquoise2","goldenrod","chocolate1", "gold", "forestgreen")) + 
  scale_color_manual(values=c("purple", "grey30","deeppink2","turquoise2","goldenrod","chocolate1", "gold", "forestgreen")) + 
  scale_alpha_manual(values=c(0.4,0,0,0,0,0,0,0)) + 
...
embedding_comp_long$model<-factor(embedding_comp_long$model, levels=c("Google Images","GPT3", "Twitter Glove", "Wiki Glove", "Bert", "ConceptNet", "FastText", "Google w2vec"))
...
##################################################
ml_cropped<-read.csv("C:/Users/dougl/Desktop/Nature_Data/ml_cropped.csv")
...
ml_uncropped<-read.csv("C:/Users/dougl/Desktop/Nature_Data/ml_uncropped.csv")
...
###############################
IMDBceleb<-read.csv("C:/Users/dougl/Desktop/Nature_Data/IMDBceleb.csv")
...
####################################
wikiceleb<-read.csv("C:/Users/dougl/Desktop/Nature_Data/wikiceleb.csv")
...
#########################################
validation_dt<-read.csv("C:/Users/dougl/Desktop/Nature_Dvalidation_task.csv")
